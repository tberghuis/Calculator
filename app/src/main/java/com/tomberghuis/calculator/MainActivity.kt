package com.tomberghuis.calculator
...
don't allow typing android keyboard
fix +/- button to toggle pos neg
fix only allow one . (decimal point)
refactor variable names
get rid of trailing 0's decimal
fix percent implementation???
 */
